...
import type { LeaderboardItem } from "@/type"
          ...
          <div className="flex justify-around mb-8">
            ...
            {sortedItems.length > 1 && (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-red-600 font-bold">
                  {(sortedItems[1].amount / 1000000000).toFixed(2)} SUI
                </span>
              </div>
            )}
            ...
            {sortedItems.length > 0 && (
              <div className="flex flex-col items-center -mt-4">
                ...
                <span className="text-xs text-red-600 font-bold">
                  {(sortedItems[0].amount / 1000000000).toFixed(2)} SUI
                </span>
              </div>
            )}
            ...
            {sortedItems.length > 2 && (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-red-600 font-bold">
                  {(sortedItems[2].amount / 1000000000).toFixed(2)} SUI
                </span>
              </div>
            )}
          </div>
            ...
            {sortedItems.slice(3).map((item, index) => (
              <div key={item.id} className="grid grid-cols-12 py-3 px-3 items-center hover:bg-red-50/50">
                ...
                <div className="col-span-4 text-right font-medium text-red-600">
                  {(item.amount / 1000000000).toFixed(2)} SUI
                </div>
              </div>
            ))}
